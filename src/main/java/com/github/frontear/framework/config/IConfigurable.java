package com.github.frontear.framework.config;
...
public interface IConfigurable<C extends IConfigurable<C>> {
    /**
     * This is called when a property with the same name as {@link IConfigurable#getName()} is found
     * from {@link IConfig#load()}
     *
    ...
    /**
     * Represents the name that is found from the json properties. Default returns {@link
     * Class#getSimpleName()}
     *
