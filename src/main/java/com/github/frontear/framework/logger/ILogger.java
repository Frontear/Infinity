package com.github.frontear.framework.logger;
...
public interface ILogger {
    /**
     * A fatal error is usually an error that will no longer allow the application to continue
     * running.
     *
    ...
    /**
     * An error usually represents something that causes an issue in a small part of the
     * application, such as a method call
     *
     * @param object An object that is converted into a string
     * @param args   Any additional objects that are passed into a {@link String#format(String,
     *               Object...)}
     ...
     * things, such as changes in the application
     *
     * @param object An object that is converted into a string
     * @param args   Any additional objects that are passed into a {@link String#format(String,
     *               Object...)}
