package com.github.frontear.framework.manager;
...
public interface IManager<T> {
    ...
    /**
     * Provides the {@link Stream} mechanism for the objects. This is so that they can make use of
     * the powerful LINQ-like features of streams
     *
