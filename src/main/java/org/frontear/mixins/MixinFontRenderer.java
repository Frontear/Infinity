...
@Mixin(FontRenderer.class) public abstract class MixinFontRenderer {
	 ...
	 * @param color      The color of the text, which will be applied via {@link org.lwjgl.opengl.GL11#glColor4f(float,
	 *                   float, float, float)}
	 * @param dropShadow If the text should have a dark back shadow. This makes the text pop out more
	 *
